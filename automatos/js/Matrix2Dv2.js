class Matrix2D {
  ...
  initialize (a, b, c, d, tx, ty) {
    this.a = (a == null) ? Matrix2D.prototype.a : a;
    this.b = b || Matrix2D.prototype.b;
    this.c = c || Matrix2D.prototype.c;
    this.d = (d == null) ? Matrix2D.prototype.d : d;
    this.tx = tx || Matrix2D.prototype.tx;
    this.ty = ty || Matrix2D.prototype.ty;
    return this;
  }
